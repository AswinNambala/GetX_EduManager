...
class _DeleteWarningState extends State<DeleteWarning> {
  final StudentsController studentsCtrl = Get.find();
  @override
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        onPressed: () {
                          studentsCtrl.deleteStudentsProfile(widget.index);

                          Get.back();
                          Get.snackbar('Delete Completed',
                              'Successfully students profile is deleted');
                        },
                        child: const Text(
                          'Delete',
